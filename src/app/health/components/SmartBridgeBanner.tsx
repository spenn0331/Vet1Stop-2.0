...
import { DocumentTextIcon, ArrowRightIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
export default function SmartBridgeBanner() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-4 rounded-xl bg-blue-50 border border-blue-200 px-4 py-3 shadow-sm">
